...
function grofiles_hovercards_init() {
	...
	// Jetpack::enable_module_configurable( __FILE__ ); // Edited by Anas H. Sulaiman
	// Jetpack::module_configuration_load( __FILE__, 'gravatar_hovercards_configuration_load' ); // Edited by Anas H. Sulaiman
}
...
// add_action( 'jetpack_modules_loaded', 'grofiles_hovercards_init' ); // Edited by Anas H. Sulaiman
add_action( 'init', 'grofiles_hovercards_init' ); // Edited by Anas H. Sulaiman
